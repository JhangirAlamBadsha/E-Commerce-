...
namespace MVT.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(MVTUserManager userManager, MVTSignInManager signInManager )
        {
        ...
        public IEnumerable<MVTUsers> SearchUsers()
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new MVTUsers { UserName = model.Email, Email = model.Email,Fullname=model.FullName,mobileNo=model.MobileNo,Address=model.Address };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new MVTUsers { UserName = model.Email, Email = model.Email };
